...
class PromptManager:
    def __init__(self, tokenizer, conv_template, instruction, target, opt_prompt, opt_place = 'suffix'):
        """
                ...
                instruction: str
                    The input instruction to the LLM
    ...
    def get_input_ids(self):
        prompt = self.get_prompt(opt_prompt=adv_string)
